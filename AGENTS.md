...
NasTech HUD Web UI — a browser-based dashboard for monitoring the NasTech AI agent. It reads agent data from `~/.nastech/` and displays identity, memory, skills, sessions, cron jobs, projects, costs, activity patterns, corrections, sudo governance, and live chat across 19 tabs.
